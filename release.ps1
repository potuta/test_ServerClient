...
$appName = "Time Client" # 👈 Replace with your application project name.
$projDir = "C:\Users\cyy\Desktop\coding\c#\Socket Programming\Time Server\Time Client" # 👈 Replace with your project directory (where .csproj resides).
